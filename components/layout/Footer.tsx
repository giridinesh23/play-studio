    ...
    <footer className="bg-dark/80 border-t border-purple/10 relative">
      ...
      <Container className="py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="font-montserrat font-semibold text-sm uppercase tracking-wider text-accent mb-4">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-text-muted">
              ...
              <li>
                {company.hours}
                {company.appointmentOnly && (
                  <span className="block text-accent text-xs mt-1">
                    By appointment only
                  </span>
                )}
              </li>
      ...
      <div className="border-t border-border">
        <Container className="py-4 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-text-muted text-xs">
            &copy; {new Date().getFullYear()} Play Studio. All Rights Reserved.
          </p>
          <Link
            href="/terms"
          ...
          {/* TODO: Add Dzongkha language toggle when translations are ready */}
        </Container>
      </div>
    </footer>
  );
